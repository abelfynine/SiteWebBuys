...
?>	
	<form method="post" action="">
		<div class="row">
			...
			<div class="col-md-2">
				<button type="submit" class="btn btn-prmiary" name="buscar"><i class="glyphicon glyphicon-search"></i> Buscar</button>
			</div>
		</div>
	</form> 
	<?php
...
while($r=mysqli_fetch_array($q)){
	...
	?>
		<div class="producto">
			...
			<h1 class="precio"><span class="precio">$<?=$r['price']?>.<?=$divisa?></span></h1>					
			<button class="btn btn-warning pull-left" onclick="agregar_carro('<?=$r['id']?>');"><i class="fa fa-shopping-cart"></i></button>
		</div>
	<?php
}
?>
