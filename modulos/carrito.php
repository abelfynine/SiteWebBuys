...
<h1 class="tituloCarrito"><i class="fa fa-shopping-cart"></i> Carro de Compras</h1>
...
<br>
<h2>Monto Total: <b><?=$monto_total?> <?=$divisa?></b></h2>

<br><br>
<form method="post" action="">
	<input type="hidden" name="monto_total" value="<?=$monto_total?>"/>
	<button class="btn btn-primary" type="submit" name="finalizar"><i class="fa fa-check"></i> 
